...
| - | ----------------------------------- | ---------------------------------- |
| `NaniteAtomicsSupported()` left as-is | Default build config; runs smoothly with Nanite disabled. <ins>Build time: unknown</ins> | Currently compiling, waiting on results, expecting a crash on launch. <ins>Build time: currently 50 minutes (Xcode 13, from scratch)</ins> |
