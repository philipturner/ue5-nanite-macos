...
After compiling the Unreal Engine from source, you may get random popups saying "XCBBuildService" crashed unexpectedly. Ignore them; they do not mean the compilation of UE5 failed.
