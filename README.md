...
Furthermore, this port needs to create major optimizations for macOS and iOS. The previous port (UE5NanitePort) ran at around 15 frames per second - far from optimal. The 64-bit atomics workaround could makes this even slower, requiring very creative thinking to maximize frame rate. A few ideas:
