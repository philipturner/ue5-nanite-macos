...
The push fails because you originally cloned a lightweight snapshot of UE5's repo. This made it shallow, prohibiting pushes to new remotes. The command below enables pushing to your remote, but may take an hour to download.
