...
Follow [this guide](https://docs.unrealengine.com/5.0/en-US/downloading-unreal-engine-source-code), starting with step 3 of "Downloading the Source Code". The instructions below are based on [this guide](https://docs.unrealengine.com/5.0/en-US/building-unreal-engine-from-source), but do not follow that hyperlinked guid; it is slightly outdated.
