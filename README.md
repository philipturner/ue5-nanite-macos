...
| - | ----------------------------------- | ---------------------------------- |
| `NaniteAtomicsSupported()` left as-is | Default build config; runs smoothly with Nanite disabled. <ins>Build time: unknown</ins> | Currently compiling, waiting on results, expecting a crash on launch. <ins>Build time: 55 minutes</ins> (Xcode 13, 8 processes, from scratch) |
